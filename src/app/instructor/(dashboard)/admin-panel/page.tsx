...
import { PanelTop, Users, BookOpen, TrendingUp, MessageSquare } from "lucide-react";
...
export default async function AdminPanelPage() {
  ...
  const links = [
    { label: "Users", href: "/instructor/users", icon: Users, value: `${studentCount + instructorCount} total` },
    { label: "All Courses", href: "/instructor/all-courses", icon: BookOpen, value: `${courseCount} courses` },
    { label: "Reports", href: "/instructor/reports", icon: TrendingUp, value: "8 reports" },
    { label: "Admin Comments", href: "/instructor", icon: MessageSquare, value: `${commentCount} comments` },
  ];
