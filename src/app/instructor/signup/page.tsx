    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--background)' }}>
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-sm mt-1" style={{ color: "var(--muted-foreground)" }}>Join as an instructor and start teaching</p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="mb-5">
              <button
                type="button"
                onClick={() => {
                  window.location.href = "/api/auth/google?role=INSTRUCTOR&intent=signup";
                }}
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="instructor-signup-password" name="password" type="password" required className="pl-9 h-11 rounded-lg" autoComplete="new-password" />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4" style={{ color: "var(--muted-foreground)" }} />
                  <Input id="instructor-signup-confirm" name="confirmPassword" type="password" required className="pl-9 h-11 rounded-lg" />
                </div>
              </div>
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "var(--muted-foreground)" }}>
          ...
          <Link href="/instructor/login" className="font-medium hover:underline" style={{ color: "var(--foreground)" }}>
            Sign in
          </Link>
        </p>
      </motion.div>
